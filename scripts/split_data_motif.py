...
parser.add_argument("--moltrees_path", default="../drug_data/grover_data/delaneyfreesolvlipo_molbert.p")
...
def load_moltrees(data_path):
    moltrees = fea_utils.load_moltrees(data_path)
    return moltrees
...
def save_moltrees(data_path, index, data):
...
def run():
    ...
    trees = load_moltrees(data_path=args.moltrees_path)
