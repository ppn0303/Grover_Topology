...
from grover.util.metrics import confusion_mat
...
def evaluate_predictions_cfm(preds: List[List[float]],
    ...
    return result_AUC, result_ACC, result_REC, result_PREC, result_SPEC, result_F1, result_BA, result_TP, result_FP, result_TN, result_FN