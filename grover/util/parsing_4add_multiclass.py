...
def add_finetune_args(parser: ArgumentParser):
    ...
    parser.add_argument('--ffn_mid_size', type=int, default=None,
                        help='Hidden dim for higher-capacity FFN (defaults to hidden_size)')
    parser.add_argument('--ffn_last_size', type=int, default=None,
                        help='Hidden dim for higher-capacity FFN (defaults to hidden_size)')
...
def add_pretrain_args(parser: ArgumentParser):
    ...
    # motif_generation args
    parser.add_argument('--topology', action='store_true', default=False, help='add topological predict')
    parser.add_argument('--motif_vocab_path', type=str, default='data/pretrain/clique.txt', help='motif vocab path')
    parser.add_argument('--motif_hidden_size', type=int, default=300, help='hidden size')
    parser.add_argument('--motif_latent_size', type=int, default=56, help='latent size')
    parser.add_argument('--motif_order', type=str, default="bfs",
                        help='motif tree generation order (bfs or dfs)')
    parser.add_argument('--wandb', action='store_true', default=False, help='add wandb log')
    parser.add_argument('--wandb_name', type=str, default = 'pretrain', help='wandb name')

    # subset_learning args
    parser.add_argument('--subset_learning', action='store_true', default=False, help='too many data!!! so I need to make subset and subset learning')
    parser.add_argument('--each_epochs', type=int, default=5, help='input how much traing subset in subset training')
...
def modify_train_args(args: Namespace):
    ...
    if not ((args.dataset_type == 'classification' and args.metric in ['auc', 'prc-auc', 'accuracy', 'f1', 'f1_weighted', 'recall', 'recall_weighted', 'sensitivity', 'specificity', 'precision', 'precision_weighted', 'total']) or
